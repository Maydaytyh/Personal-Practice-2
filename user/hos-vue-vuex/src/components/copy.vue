...
<div class="copy">
    ...
    <el-dialog title="复制用户" :visible.sync="dialogFormVisible">
        ...
        <el-form-item label="可查机构" :label-width="formLabelWidth">
            <el-select v-model="userForm.fy" placeholder="请选择"  @change="getDeparts" multiple disabled>
            <el-option
        ...
        <el-form-item label="可查科室" :label-width="formLabelWidth">
            <el-select v-model="userForm.ks" placeholder="请选择" multiple disabled>  
            <el-option
                v-for="item in ks"
                :key="item.key"
                :label="item.value"
        ...
        <el-form-item label="所属组" :label-width="formLabelWidth">
            <el-select v-model="userForm.groups" placeholder="请选择" multiple disabled>
                <el-option
