...
<div class="update">
    ...
    <el-dialog title="修改用户" :visible.sync="dialogFormVisible">
        ...
        <!-- <el-form-item label="确认口令" :label-width="formLabelWidth" prop="confirmPassword" required>
            <el-input type="password" v-model="currentUser.confirmPassword" auto-complete="off"></el-input>
        </el-form-item> -->
        ...
        <el-form-item label="是否管理员" :label-width="formLabelWidth">
                <el-select v-model="createCurrentUser.manager" placeholder="请选择是否管理员">
        ...
        <el-form-item label="所属组" :label-width="formLabelWidth">
            <el-select v-model="createCurrentUser.groups" multiple placeholder="请选择">
                <el-option
